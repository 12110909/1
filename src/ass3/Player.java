...
public class Player {
    ...
    public boolean checkIdentity(Mail mail, String password){
        return this.mail.getMail().equals(mail.getMail()) && password.equals(this.password);

    }
    public boolean checkIdentity(PhoneNumber phoneNumber, String password){
        return phoneNumber.getPhoneNumber().equals(this.phoneNumber.getPhoneNumber()) && password.equals(this.password);
